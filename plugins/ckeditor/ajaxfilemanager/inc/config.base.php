...
$_GET['language'] = $_GET['langCode'];
	...
	//define('CONFIG_SYS_ROOT_PATH', '../uploaded/');	//accept relative path only
        if (!empty($_SESSION['FileBroserFolder'])){
		define('CONFIG_SYS_DEFAULT_PATH', '../../../'.$_SESSION['FileBroserFolder'].'/'); //accept relative path only
		define('CONFIG_SYS_ROOT_PATH', '../../../'.$_SESSION['FileBroserFolder'].'/');	//accept relative path only
	}else{
		define('CONFIG_SYS_DEFAULT_PATH', 'none/'); //accept relative path only
		define('CONFIG_SYS_ROOT_PATH', 'none/');	//accept relative path only
	}
	...
	define('CONFIG_UPLOAD_MAXSIZE', $_SESSION['FileBroserMaxUploadFileSize']);  // by Alex
	...
	define('CONFIG_UPLOAD_VALID_EXTS', $_SESSION['FileBroserAllowedExts']);	// by Alex
