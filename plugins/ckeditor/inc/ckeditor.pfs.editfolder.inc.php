...
/* ====================
 ...
 ==================== */
/**
 * Personal File Storage, Ådit Folder Part
 *
...
$title = "<a href=\"".sed_url('plug',"o=ckeditor&".$more, '', true)."\">".$L['pfs_title']."</a>";
...
$body .= "<form id=\"editfolder\" action=\"".sed_url('plug',"o=ckeditor&m=editfolder&a=update&f=".$pff_id.'&'.$more)."\" method=\"post\"><table class=\"cells\">";
