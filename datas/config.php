...
$cfg['mysqldb'] = 'devcmsworks_db';			// Database name
...
$cfg['mainurl'] = 'http://dev.cmsworks.dev';
$cfg['site_id'] = 'erew4rf4rd44r4r4r4f4r44redere';
$cfg['secret_key'] = 'dsgnfkdfkdfjgnkdlkjhtr44rnfjfrgjltyh0hgkghfnf';

// ========================
// Default skin and default language
// ========================

$cfg['defaultskin'] = 'light';	// Default skin code. Be SURE it's pointing to a valid folder in /skins/... !!
$cfg['defaulttheme'] = 'light';	// Default theme, only name, not like skinname.css. Be SURE it's pointing to a valid folder in /skins/defaultskin/... !!
$cfg['defaultlang'] = 'ru';		// Default language code
$cfg['enablecustomhf'] = FALSE;		// To enable header.$location.tpl and footer.$location.tpl

$cfg['xtpl_cache'] = FALSE;		// Enable XTemplate structure disk cache
